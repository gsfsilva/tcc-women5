<footer>
    <div id="footer_content">
        <div id="footer_contacts">
            ...
            <div id="footer_social_media">
                <ul class="example-2">
                    ...
                    <li class="icon-content">
                        <a href="https://www.instagram.com/_womens.forum/" aria-label="Instagram"
            ...
            <ul class="footer-list">
                ...
                <li>
                    <a href="https://github.com/gsfsilva" class="footer-link">Gustavo: UX/UI Designer <> Web developer</a>
                </li>
            </ul>
        </div>
        ...
        <div id="footer_copyright">
            <p>&copy; 2024 Women’s Forum. Todos os direitos reservados.</p>
        </div>
    </div>
</footer>